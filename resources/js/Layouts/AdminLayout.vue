...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        <g id="SVGRepo_bgCarrier" stroke-width="0"/>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
        <g id="SVGRepo_iconCarrier"> <path d="M8.10008 21.221C6.71021 19.2375 5.89258 16.8243 5.89258 14.2187C5.89258 10.8443 8.6265 8.10938 11.9989 8.10938C15.3712 8.10938 18.1051 10.8443 18.1051 14.2187" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M8.10008 21.221C6.71021 19.2375 5.89258 16.8243 5.89258 14.2187C5.89258 10.8443 8.6265 8.10938 11.9989 8.10938C15.3712 8.10938 18.1051 10.8443 18.1051 14.2187" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M18.4361 20.3118C18.3262 20.3179 18.2182 20.3281 18.1073 20.3281C14.7349 20.3281 12.001 17.5931 12.001 14.2188" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M18.4361 20.3118C18.3262 20.3179 18.2182 20.3281 18.1073 20.3281C14.7349 20.3281 12.001 17.5931 12.001 14.2188" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M13.2694 21.9999C10.675 20.382 8.94705 17.5024 8.94705 14.2187C8.94705 12.5315 10.3145 11.164 12.0007 11.164C13.6869 11.164 15.0543 12.5315 15.0543 14.2187C15.0543 15.9059 16.4218 17.2733 18.108 17.2733C19.7942 17.2733 21.1616 15.9059 21.1616 14.2187C21.1616 9.1571 17.0602 5.05469 12.0017 5.05469C6.94319 5.05469 2.8418 9.1571 2.8418 14.2187C2.8418 15.3469 2.96806 16.4455 3.20021 17.5045" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M13.2694 21.9999C10.675 20.382 8.94705 17.5024 8.94705 14.2187C8.94705 12.5315 10.3145 11.164 12.0007 11.164C13.6869 11.164 15.0543 12.5315 15.0543 14.2187C15.0543 15.9059 16.4218 17.2733 18.108 17.2733C19.7942 17.2733 21.1616 15.9059 21.1616 14.2187C21.1616 9.1571 17.0602 5.05469 12.0017 5.05469C6.94319 5.05469 2.8418 9.1571 2.8418 14.2187C2.8418 15.3469 2.96806 16.4455 3.20021 17.5045" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M20.5257 5.86313C18.4435 3.4978 15.399 2 12.0002 2C8.60136 2 5.55687 3.4978 3.47461 5.86313" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> <path d="M20.5257 5.86313C18.4435 3.4978 15.399 2 12.0002 2C8.60136 2 5.55687 3.4978 3.47461 5.86313" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </g>
        </svg>`,
        label: 'Роли',
        roles: ['Администратор'],
      ...
      },
      {
        ...
        label: 'Курсы',
        roles: ['Администратор', 'Куратор'],
        children: [
          { label: 'Список', route: 'admin.courses.index' },
          { label: 'Лекции', route: 'admin.themes.index' }
        ]
      },
      {
        icon: `<svg fill="#000000" width="18" height="18" viewBox="0 0 24 24" id="check-mark-square-2" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" class="icon flat-line">
          ...
          <path id="primary-2" data-name="primary" d="M21,11v9a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V4A1,1,0,0,1,4,3H16" style="fill: none; stroke: #ffffff; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"/> </g>
          </svg>`,
        label: 'Задания',
        roles: ['Администратор', 'Куратор'],
      ...
      {
        icon: `<svg width="18px" height="18px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
          <g id="SVGRepo_bgCarrier" stroke-width="0"/>
          <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
          <g id="SVGRepo_iconCarrier"> <defs> <clipPath id="clip-computer"> <rect width="32" height="32"/> </clipPath> </defs> <g id="computer" clip-path="url(#clip-computer)"> <g id="Group_3463" data-name="Group 3463"> <g id="Group_3456" data-name="Group 3456"> <g id="Group_3449" data-name="Group 3449"> <g id="Group_3448" data-name="Group 3448"> <g id="Group_3447" data-name="Group 3447"> <path id="Path_4068" data-name="Path 4068" d="M22.083,28.164H9.917a1,1,0,1,1,0-2H22.083a1,1,0,0,1,0,2Z" fill="#ffffff"/> </g> </g> </g> <g id="Group_3452" data-name="Group 3452"> <g id="Group_3451" data-name="Group 3451"> <g id="Group_3450" data-name="Group 3450"> <path id="Path_4069" data-name="Path 4069" d="M30.417,24.17H1.583a1,1,0,0,1-1-1V4.836a1,1,0,0,1,1-1H30.417a1,1,0,0,1,1,1V23.17A1,1,0,0,1,30.417,24.17Zm-27.834-2H29.417V5.836H2.583Z" fill="#ffffff"/> </g> </g> </g> <g id="Group_3455" data-name="Group 3455"> <g id="Group_3454" data-name="Group 3454"> <g id="Group_3453" data-name="Group 3453"> <path id="Path_4070" data-name="Path 4070" d="M19.917,27.664H12.083a.5.5,0,0,1-.5-.5V23.17a.5.5,0,0,1,.5-.5h7.834a.5.5,0,0,1,.5.5v3.994A.5.5,0,0,1,19.917,27.664Zm-7.334-1h6.834V23.67H12.583Z" fill="#ffffff"/> </g> </g> </g> </g> <g id="Group_3459" data-name="Group 3459"> <g id="Group_3458" data-name="Group 3458"> <g id="Group_3457" data-name="Group 3457"> <path id="Path_4071" data-name="Path 4071" d="M30.146,18.813H1.854a.5.5,0,1,1,0-1H30.146a.5.5,0,0,1,0,1Z" fill="#ffffff"/> </g> </g> </g> <g id="Group_3462" data-name="Group 3462"> <g id="Group_3461" data-name="Group 3461"> <g id="Group_3460" data-name="Group 3460"> <circle id="Ellipse_35" data-name="Ellipse 35" cx="0.875" cy="0.875" r="0.875" transform="translate(15.125 19.625)" fill="#ffffff"/> </g> </g> </g> </g> </g> </g>
          </svg>`,
