<template>
  ...
  <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 my-4">
    <div class="bg-white dark:bg-opacity-5 shadow-xl rounded-lg xl:rounded-tr-3xl mb-4 p-4 sm:p-6 w-full h-full border dark:border-none">
      <h3 class="text-xl font-bold dark:text-white text-center">Текущие курсы</h3>

    </div>
    <div class="overflow-x-auto bg-white dark:bg-opacity-5 shadow-xl rounded-lg xl:rounded-tl-3xl mb-4 p-4 sm:p-6 w-full h-full border dark:border-none">
