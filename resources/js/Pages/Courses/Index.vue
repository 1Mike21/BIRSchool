...
.all-courses__item {
  @apply flex flex-col text-black dark:text-white text-xl xl:text-2xl bg-white dark:bg-opacity-5 p-5 pb-6 gap-y-5 border-[3px] border-darkblue dark:border-white rounded-28 w-full sm:w-[292px] md:w-[357px] lg:w-[315px] xl:w-[295px] 2xl:w-[360px] min-h-72 shadow-2xl dark:shadow-none;
}
.btn-more-detail {
