<template>
  <div class="relative">
    <span @click="toggleVisibility" class="cursor-pointer absolute top-1/4 right-10">
...
import { useHidePassword } from '@/Hooks/hidePassword';
...
const { passwordVisible, toggleVisibility, checkType } = useHidePassword();
</script>
