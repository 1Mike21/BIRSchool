...
const classes = computed(() => {
  return props.active
    ? 'block w-full ps-3 px-3 py-2 mb-1 rounded-md text-start text-base font-medium text-white bg-indigo-950 hover:bg-indigo-900  transition duration-150 ease-in-out'
