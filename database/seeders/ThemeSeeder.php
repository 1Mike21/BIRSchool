...
class ThemeSeeder extends Seeder
{
  ...
  public function run(): void
  {
    DB::table('themes')->insert([
      ...
      [
        'title' => 'Работа с блочной моделью',
        'slug' => 'working-with-the-block-model',
        'content' => '',
        'course_id' => 2,
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
      ...
      [
        'title' => 'Работа с flexbox',
        'slug' => 'work-with-flexbox',
        'content' => '',
        'course_id' => 2,
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
      ...
      [
        'title' => 'Адаптивный дизайн с помощью медиа-запросов',
        'slug' => 'responsive-design-using-media-queries',
        'content' => '',
        'course_id' => 2,
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
